...
def extract_kapture_keypoints(args):
    ...
    with get_all_tar_handlers(args.kapture_root,
        ...
        for image_name in image_list:
            ...
            # Set output path to parent directory of kapture_root
            output_path = path.join(args.kapture_root, os.pardir)
            ...
            keypoints_fullpath = get_keypoints_fullpath(args.keypoints_type, output_path,
            ...
            descriptors_fullpath = get_descriptors_fullpath(args.descriptors_type, output_path,
                                                            image_name, tar_handlers)
